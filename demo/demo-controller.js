...
(function () {
    ...
    function demoController($scope, $log) {
        ...
        $scope.restrictDates = restrictDates;
        ...
        function restrictDates(dateFrom, dateTo, dates, view) {
            $log.log(view);
            dateFrom = luxon.DateTime.fromJSDate(dateFrom);
            dateTo = luxon.DateTime.fromJSDate(dateTo);
            for (const date of dates) {
                date.selectable = dateFrom.startOf(view) <= date.dateTime.startOf(view) && date.dateTime.startOf(view) <= dateTo.startOf(view);
                $log.log(date.dateTime);
            }
        }
    }
})();
