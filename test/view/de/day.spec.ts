...
describe('German day view with initial date of 2013-01-22', () => {
    let element;
    beforeEach(() => angular.mock.module(dateTimePickerModule));
    beforeEach(() => inject(($compile, $rootScope) => {
        Settings.defaultLocale = 'de';
    ...
    it('has 1 `.past` elements', () => {
        expect(jQuery('.past', element).length).toBe(1);
    });
    it('has 10 `.future` elements', () => {
...
describe('day with initial date of "2020-01-01T00:00:00.000" and minView="day"', () => {
    ...
    it('clicking the 13th `.day` element will set the date value to 2020-01-11T00:00:00.000"', () => {
