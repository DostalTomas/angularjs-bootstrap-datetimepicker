...
describe('beforeRender', function () {
    ...
    describe('called before a new view is rendered', function () {
        it('in year view $dates parameter contains 12 members', function () {
            $rootScope.date = luxon.DateTime.fromISO('2008-01-01T00:00:00.000').toJSDate();
            ...
            expect($rootScope.date).toEqual(luxon.DateTime.fromISO('2001-01-01T00:00:00.000').toJSDate());
        ...
        it('in month view $dates parameter contains 12 members', function () {
            ...
            expect(selectedElement.hasClass('disabled')).toBeFalsy();
            selectedElement.trigger('click');
            expect($rootScope.date).toEqual(luxon.DateTime.fromISO('2008-05-01T00:00:00.000').toJSDate());
        ...
        it('in day view $dates parameter contains 42 members', function () {
            ...
            expect($rootScope.date).toEqual(luxon.DateTime.fromISO('2014-01-01T00:00:00.000').toJSDate());
            ...
            selectedElement.trigger('click');
            expect($rootScope.date).toEqual(luxon.DateTime.fromISO('2014-01-09T00:00:00.000').toJSDate());
        ...
        it('$rightDate parameter is the beginning of the next view', function () {
            $rootScope.date = luxon.DateTime.fromISO('2014-04-01T00:00:00.000').toJSDate();
        ...
        it('startview = "day" and $upDate parameter is the beginning of the next view up ', function () {
            ...
            $rootScope.date = luxon.DateTime.fromISO('2014-10-18T13:00:00.000').toJSDate();
        ...
        it('startview = "hour" and $upDate parameter is the beginning of the next view up ', function () {
            ...
            $scope.date = luxon.DateTime.fromISO('2014-10-18T13:00:00.000').toJSDate();
        ...
        it('year view and 2001 date is disabled', function () {
            ...
            expect($rootScope.beforeRender).toHaveBeenCalled();
            expect($rootScope.date).toEqual(luxon.DateTime.fromISO('2008-01-01T00:00:00.000').toJSDate())
        })
    })
});
